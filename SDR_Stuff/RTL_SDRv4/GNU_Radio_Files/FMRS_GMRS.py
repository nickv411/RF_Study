...
class FMRS_GMRS(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "FMRS_GMRS")
        ...
        self.qtgui_freq_sink_x_0.set_y_axis(-110, -50)
        ...
        self.osmosdr_source_0.set_center_freq(variable_freq, 0)
...
def main(top_block_cls=FMRS_GMRS, options=None):
